...
L’ANSSI communiquera sur la directive NIS\xa02 tout au long de la transposition à l’échelle nationale, partageant à
...
Dernière mise à jour de cette FAQ\xa0: 07/07/2023

## Introduction

### 1. En 2016, le Parlement et le Conseil de l’UE ont adopté une première série de mesures concernant la cybersécurité du marché européen. En quoi consistait exactement cette directive connue sous le nom de NIS 1\xa0?
...
### 2. Qu’est-ce qui va changer avec l’adoption de la directive NIS\xa02\xa0?

La directive NIS\xa02 est extrêmement ambitieuse. Elle s’appuie sur les acquis de la directive NIS 1 pour marquer un
...
directive NIS\xa02 élargit en effet ses objectifs et son périmètre d’applicabilité pour apporter davantage de
protection. Cette extension du périmètre prévue par NIS\xa02 est sans précédent en matière de réglementation cyber.

### 3. Pourquoi cette directive revêt une telle importance stratégique pour les pays membres de l’Union Européenne\xa0?

Alors que la menace complexe, professionnelle et en constante évolution ne faiblit pas et que les systèmes
d’information restent pour partie vulnérables, la directive NIS\xa02 représente une opportunité unique\xa0: sa mise en
...
### 4. Quel est l’objectif derrière la régulation des TPE / PME\xa0?
...
mesures de protection de base face à la cybercriminalité sont donc des enjeux essentiels du dispositif NIS\xa02.

## Périmètre des entités concernées

### 5. Comment savoir si je suis concerné par NIS\xa02\xa0?

À ce jour, la directive NIS\xa02 comprend des annexes 1 et 2 dans lesquelles il est indiqué les secteurs, sous-secteurs
et les types d’entité concernés. Si votre entité se retrouve dans un des secteurs, sous-secteur et type d’entité et
que vous respectez les critères de taille, alors vous serez concerné par la directive NIS\xa02. En revanche, si vous ne
...
### 6. Quelle mise en œuvre et pilotage en Outre-mer\xa0?
...
directive NIS\xa02 offre à l’ANSSI la possibilité de travailler sur le périmètre des collectivités territoriales, mais
...
### 7. Je suis une collectivité territoriale, serais-je concerné par NIS\xa02\xa0?

Aujourd'hui, l’ANSSI constate que le niveau de la menace contre les collectivités territoriales est élevé et cela a
des effets délétères au niveau sociétal. La directive NIS\xa02 prévoit la régulation d’entités privées et des
...
selon nous de ne pas saisir l’opportunité d’inclure les collectivités territoriales dans le dispositif NIS\xa02, au même
titre que les entités privées et les administrations publiques.

### 8. Si mon entreprise est sur deux Etats membres, est-ce que je suis assujetti à la transposition en droit français de NIS\xa02\xa0?
...
soumis à la directive NIS\xa02. En revanche, si vous souhaitez connaitre la juridiction, c’est encore un peu tôt pour
obtenir une réponse, car ce point fera l’objet de clarifications dans le cadre des consultations menées dans les
prochains mois.

### 9. Les entités n’étant plus désignées par arrêté et devant se faire connaitre auprès d’elle, l’ANSSI envisage-t-elle des actions pour faciliter la mise en relation\xa0?

Effectivement, la règle de base impliquera une inclusion par défaut des entités en tant qu’EE ou EI. La désignation
...
### 10. Le texte prévoit un certain nombre d’exceptions ou de cas particuliers au périmètre de base. Dans quels cas, l’ANSSI sera-t-elle amenée à actionner les mécanismes d’ajustement du périmètre\xa0?
...
### 11. Concrètement, qui sera concerné par le nouveau périmètre d’application de NIS\xa02\xa0?

À l’échelle nationale, NIS\xa02 s’appliquera à des milliers d’entités appartenant à plus de dix-huit secteurs qui
...
### 12. Qu’en est-il des acteurs de la chaine d’approvisionnement, des administrations et des collectivités territoriales\xa0?
...
collectivités territoriales intègreront également le périmètre de NIS\xa02.

# Obligations

### 13. Y a-t-il un document qui recense l’ensemble des mesures pour être conforme avec NIS\xa02\xa0?
...
### 14. Comment les obligations de NIS\xa02 seront ajustées aux capacités à faire des ETI\xa0?
...
### 15. Y aura-t-il des nouveautés concernant le cloisonnement et le SI d'Admin\xa0?

Pas à ce stade. Ces deux mesures de protection efficaces peuvent être affiliées aux mesures de NIS\xa02 qui sont
...
### 16. Toutes les nouvelles entités concernées seront-elles soumises aux mêmes obligations\xa0?

NIS\xa02 apporte une évolution majeure\xa0: l’inclusion d’un mécanisme de proportionnalité, qui distingue deux
catégories
d’entités régulées en fonction de leur niveau de criticité\xa0: les entités essentielles et les entités importantes.
L’ANSSI compte s’appuyer sur cette notion pour définir des exigences adaptées et proportionnées aux enjeux de
chacune de ces catégories.

### 17. Quel sera le coût financier pour les entités\xa0?
...
### 18. Quelles mesures vont être appliquées pour les nouveaux entrants\xa0?
...
### 19. Quelle est la date officielle d’entrée en vigueur de NIS\xa02\xa0?

La directive NIS\xa02 a été publiée le 27 décembre 2022 au Journal Officiel de l’Union Européenne et elle prévoit un
délai de 21 mois pour que chaque Etat membre transpose en droit national les différentes exigences réglementaires.
NIS\xa02 rentrera donc en vigueur en France au plus tard en octobre 2024. À ce jour, il n’est pas possible de donner
...
entités régulées\xa0: certaines exigences seront d’application directe et d’autres seront soumises à un délai de mise en
conformité.

### 20. Quels sont les secteurs qui doivent être définis plus précisément\xa0?
...
quant aux entités concernées par NIS\xa02, et cela, pour tous les secteurs concernés sans distinction.

### 21. Comment se matérialise cette co-construction\xa0?

La co-construction prévue par l’ANSSI débutera par une phase de consultation autour de trois thématiques. Elle aura
donc pour objectif de définir précisément\xa0:
...
Une seconde phase de co-construction consistera ensuite à affiner les processus et les moyens qui devront être mis en
œuvre pour accompagner les futurs opérateurs régulés dans l'application de la réglementation NIS\xa02. Cela permettra
...
### 22. Quel est le calendrier global de transposition de la directive\xa0?

Afin de respecter l’échéance européenne fixée en octobre 2024, l’ANSSI envisage\xa0:
...
### 23. Comment l’ANSSI assurera le respect de la réglementation\xa0?
...
adaptés au passage à l’échelle que représente NIS\xa02. L’ANSSI travaille également à faciliter ses interactions avec
...
### 24. La directive NIS\xa02 sera-t-elle également synonyme d’un renforcement du régime de sanction\xa0?
...
### 25. Est-ce que la méthode de l’ANSSI va changer avec cette nouvelle règlementation\xa0?
...
directive NIS\xa02, l’objectif reste inchangé : élever le niveau global de sécurité numérique en France en permettant
aux entités concernées de mieux se protéger face à la menace.

### 26. Quel type d’accompagnement peuvent attendre de l’ANSSI les entités susceptibles d’être concernées par NIS\xa02\xa0?
...
réglementaires\xa0: cette démarche permettra d’obtenir un niveau de préparation au risque cyber à la fois ambitieux et
...
### 27. Comment les entités qui sont concernées par NIS\xa02 peuvent se préparer à sa transposition dans le droit national\xa0?
...
désignées au titre de NIS 1, il n’est pas d’actualité de relâcher l'effort\xa0! D’ici à l’entrée en vigueur de NIS\xa02,
les exigences de NIS 1 demeurent applicables et l’ANSSI continueront à contrôler leur mise en œuvre. En outre, les
futures exigences de NIS\xa02 s’inscriront dans le prolongement naturel des efforts
de [NIS\xa01](https://www.ssi.gouv.fr/uploads/2020/12/guide_protection_des_systemes_essentiels.pdf) et tous les travaux
d’ores et déjà entrepris par les opérateurs seront valorisés dans NIS\xa02. L’ANSSI a bien identifié cette nécessaire
continuité comme une priorité de la transposition de NIS\xa02.

## Organisation ANSSI

### 28. Quelles sont les implications de cette directive sur l’organisation interne de l’ANSSI\xa0?

Les implications de NIS\xa02 sur l’organisation de l’ANSSI sont conséquentes, notamment au regard de la
démultiplication à venir des entités régulées. L’enjeu pour l’ANSSI sera d’adapter son dispositif et ses méthodes
afin de maintenir un effort substantiel sur ce qui a fait le succès de son action jusqu’à présent\xa0: le conseil et
l’accompagnement.
...
### 29. L’ANSSI sera-t-elle en mesure de supporter un tel accroissement de périmètre\xa0?

Le passage à l’échelle est un des enjeux majeurs de transposition de la directive NIS\xa02. Dans la continuité de son
action et des services déjà déployés (MonServiceSécurisé…), l’ANSSI envisage de déployer de nouveaux services
(numériques pour certains) permettant d’interagir avec les futurs milliers d’entités régulées par NIS\xa02. Il s’agira
...
### 30. Quel sera le rôle des DPOs dans NIS\xa02\xa0? Et comment optimiser la collaboration DPO / RSSI\xa0?

Le RGPD et la directive NIS\xa02 sont deux cadres réglementaires distincts avec des autorités régulatrices différentes.
La directive NIS\xa02 traitre des systèmes d’information et de la continuité d’activité alors que le RGPD traitre des
données à caractère personnel.

La notion de DPO, qui est très pertinente pour le RGPD, n’est pas entièrement transposable dans NIS\xa02 comme elle ne
l’était déjà pas dans NIS 1. Cependant, l’ANSSI ne sera pas prescriptive sur le rôle du DPO. Dès lors, rien ne
s’opposera à l’utilisation du dispositif RGPD et des DPO s’ils concourent aux objectifs de NIS\xa02. Ce qui a été mis
en place au titre du RGPD est potentiellement mutualisable avec la directive NIS\xa02 et ce sera à chaque entité de
déterminer le meilleur fonctionnement possible.

### 31. Comment serait-il possible de concilier le régime NIS\xa02 avec le volet cyber de la LPM 2013 s’appliquant aux OIV\xa0?

Certains OIV seront régulés au titre de NIS\xa02, et d’autres non. Nous avons donc prévu, dans le cadre de la
transposition en droit nationale de NIS\xa02, d’embarquer dans les textes, que ce soit au niveau législatif ou
...
### 32. Quelle est l’articulation NIS\xa02 et le Cyber Resilience Act\xa0?
...
donc complémentaire à la directive NIS\xa02 qui traite d’opérateurs de services. De manière simplifiée, le CRA visera à
sécuriser des produits connectés utilisés par le grand public de l’UE alors que NIS\xa02 a pour objectif de sécuriser
les moyens de productions des entreprises et administrations de l’UE.

### 33. Comment l’ANSSI travaille avec les différents services de l'État pour éviter un empilement des normes avec NIS\xa02\xa0?

La directive NIS\xa02 prévoit des mécanismes de fonctionnement rapprochés entre les autorités nationales NIS\xa02 et les
...
l’opportunité offerte par la directive NIS\xa02 pour réviser l’articulation des cadres réglementaires existants en
