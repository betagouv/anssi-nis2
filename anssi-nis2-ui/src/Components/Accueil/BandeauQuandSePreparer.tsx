          ...
          <div className="fr-grid-row">
            ...
            <div className="fr-col">
              <p className="fr-text--lead fr-text--bold fr-pb-4v">
                L’administration française a jusqu’au 17 octobre 2024 pour
                transposer les obligations de cette directive dans le droit
                national. Son entrée en vigueur, marquant le début des délai de
                mise en conformité, peut donc être estimée à<br />
                <span className={cx([classes["mea-faits"]], className)}>
                  fin de 2e semestre 2024.
                </span>
              </p>
              <p className="fr-text--lead  fr-pb-4v">
                Pour améliorer au plus tôt votre protection face aux menaces
                cyber et vous préparer à ces futures obligations, suivez-nous
                dès à présent.
              </p>
