  ...
  return (
    <FormSimulateur>
      <div className='fr-fieldset__element'>
        ...
        <RadioButtons
          options={optionsFournitServicesUnionEuropeenne}
        />
      </div>
      {estFournisseurServiceUnionEuropeenne && (
        <div className='fr-fieldset__element'>
          <legend className='fr-text--medium'>
          Dans quel pays sera établi votre représentant dans l&apos;Union Européenne&nbsp;?
          </legend>
          <RadioButtons
            options={optionsLocalisationRepresentant}
          />
        </div>
      )}
    </FormSimulateur>
