...
const SimulateurAvantDebuter = () =>
    <div className="fr-grid-row fr-grid-row-gutters fr-grid-row--center">
        <div className="fr-col-12 fr-col-md-10 fr-col-lg-9">
            ...
            <p className="fr-text">
                Avec votre accord, nous souhaiterions enregistrer le nom de votre organisation
                ainsi que votre adresse électronique dans le cadre des travaux de conception de
                cet outil et à des fins d’amélioration du service.
            </p>
            <p className="fr-text">
                Si vous le souhaitez, ces informations nous permettrons ausssi de vous tenir
                informé des évolutions de la directive NIS2.
            </p>
                ...
                <fieldset className="fr-mb-0 fr-fieldset" id="login-1797-fieldset"
                    ...
                    <div className="fr-fieldset__element">
                        <Checkbox
                            options={[
                                {
                                    label: "J’autorise l’ANSSI à me tenir informé des évolutions de la directive NIS2",
                                    nativeInputProps: {
                                ...
                                {
                                    label: "J’autorise l’ANSSI à conserver ces information à des fins d’amélioration du service",
                                    nativeInputProps: {
