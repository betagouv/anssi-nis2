...
import {tranchesCA, tranchesNombreEmployes} from "../../Domaine/DomaineSimulateur.ts"
...
const SimulateurEtape3 = () => {
    ...
    const optionsTranchesCA =
        transformeTranchesCAVersOptions(tranchesCA)

    return <div className="fr-fieldset__element">
        <p>Quelles sont les caractéristiques clés de votre organisation ?
            Texte de description additionnel</p>
        <RadioButtons
