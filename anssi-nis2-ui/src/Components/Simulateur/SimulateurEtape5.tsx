...
const SimulateurEtape5 = () => {
    const valeursActivites = detailsDesSecteurs.energie.sousSecteurs?.electricite.activites || {}
    const transformateurSecteurActivite = genereTransformateurValeursVersOptions<string>(
        (cle: string, valeurs: Record<string, string>) => valeurs[cle],
        "activiteSousSecteurElectricite",
    )
    const optionsSecteurActivite = transformateurSecteurActivite(valeursActivites)
