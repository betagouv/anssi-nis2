...
export const secteursActivite: Record<ValeursSecteurActivite, string> = {
    ...
    fabricationProductionEtDistributionDeProduitsChimiques: "Fabrication, production et distribution de produits chimiques",
    ...
    productionTransformationEtDistributionDeDenreesAlimentaires: "Production transformation et distribution de denrées alimentaires",
    recherche: "Recherche",
    sante: "Santé",
...
const sousSecteursEnergie: Record<ValeursSousSecteurEnergie, DescriptionSousSecteur> = {
    electricite: {
        libelle: "Électricité",
        activites: {
            "entrepriseElectriciteRemplissantUneFonctionDeFourniture": "Entreprise d’électricité remplissant une fonction de fourniture",
...
export const detailsDesSecteurs: Record<ValeursSecteurActivite, DescriptionSecteur> = {
    ...
    productionTransformationEtDistributionDeDenreesAlimentaires: {activites: {}},
    recherche: {activites: {}},
    sante: {activites: {}},
