...
import {LienRubrique} from "./Components/Directive/LienRubrique.tsx";
    ...
    <>
      <MiseEnPage page="Directive NIS 2">
          ...
          <div className="fr-nis2-directive">
              ...
              <details className="sommaire fond-blanc">
              ...
              <div className="bloc fond-blanc aucune-marge-basse">
                  ...
                  <div id="mot-du-directeur">
                      ...
                      <p>Face à une cybermenace qui s’accroit, NIS 2 relève le défi d’une meilleure sécurisation des
