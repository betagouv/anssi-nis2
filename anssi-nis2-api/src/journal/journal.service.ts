...
export class JournalService {
  constructor(
    ...
    private evenementsRepository: Repository<Evenements>, // @InjectRepository(SegmentsConcernesNis2) // private concerneNis2Repository: Repository<SegmentsConcernesNis2>,
  ) {}
